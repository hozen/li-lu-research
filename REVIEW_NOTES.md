...
| P2-4 | 新增可折叠时间线 | timeline.html | ✅ 已完成 | collapsible era sections with expand/collapse all controls | 公开活动索引 |
| P2-5 | 术语表精简 | glossary.html | ✅ 已完成 | 11→8术语：移除经济护城河(重复)、内在记分卡(偏巴菲特)、无缝信任网(子概念) |
| P2-4 | 新增可折叠时间线 | timeline.html | ✅ 已完成 | collapsible era sections with expand/collapse all controls | |
| P2-6 | 书架加购买链接 | bookshelf.html | 🔴 待处理 | |

## 2026-04-07 更新 (P2-4 完成)

### P2-4: 可折叠时间线
- **文件**: timeline.html
- **变更**: 将时间线按时代分组（童年/求学、留学/转型、投资生涯、重大里程碑），每个时代可独立折叠/展开
- **新增**:
  - 顶部「全部展开/全部折叠」控制按钮
  - 4个时代分组，每组有可点击的时代标题栏
  - CSS过渡动画实现平滑展开/折叠效果
  - 深色模式适配
- **Playwright 测试**: 7 pages / 0 errors ✅
- **推送**: GitHub API → dev branch (commit 4d2b1f7)
